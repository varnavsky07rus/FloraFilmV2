package com.alaka_ala.florafilm.ui.util.api.hdvb;
...
public class HDVBSelector {
    ...
    public HDVBSelector(LinearLayout root, EPData.Film film, ItemFilmInfo filmInfo) {
    ...
    public HDVBSelector(LinearLayout root, EPData.Serial serial, ItemFilmInfo filmInfo) {
        this.filmInfo = filmInfo;
    ...
    private void createFilmSelector() {
        ...
        for (int i = 0; i < film.getTranslations().size(); i++) {
            String titleTranslation = film.getTranslations().get(i).getTitle() + " | [HDVB]";
                    ...
                    for (int i = 0; i < sizeVideos; i++) {
                        ...
                        linearLayoutTitleClick2.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View vQuality) {
                                ...
                                builderEPData.setBalancer("HDVB");
    ...
    private void createSerialSelector() {
        ...
        String titleBalancer = blockList.toString().isEmpty() ? "HDVB" : "HDVB (" + blockList.toString() + ")";
