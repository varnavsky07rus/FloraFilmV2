...
public class LumexSelector {
    ...
    public LumexSelector(LinearLayout root, String CURRENT_TYPE_CONTENT) {
        this.root = root;
    ...
    public LumexSelector(LinearLayout root, EPData.Film film, ItemFilmInfo filmInfo) {
    ...
    public LumexSelector(LinearLayout root, EPData.Serial serial, ItemFilmInfo filmInfo) {
        this.filmInfo = filmInfo;
    ...
    private void createFilmSelector() {
        ...
        for (int i = 0; i < film.getTranslations().size(); i++) {
            String titleTranslation = film.getTranslations().get(i).getTitle() + " | LUMEX";
                    ...
                    for (int i = 0; i < sizeVideos; i++) {
                        ...
                        linearLayoutTitleClick2.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View vQuality) {
                                ...
                                builderEPData.setBalancer("LUMEX");
    ...
    private void createSerialSelector() {
        ...
        String titleBalancer = blockList.toString().isEmpty() ? "LUMEX" : "LUMEX (" + blockList.toString() + ")";
